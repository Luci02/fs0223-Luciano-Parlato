...
for (let i = 0; i < starWarsCharacters.length; i++) {
  ...
  switch (starWarsCharacters[i].eye_color) {
    ...
    case "red":
      ...
      break;
    case "blue-gray":
      eyeColor["blue-gray"] = starWarsCharacters[i];
  }
...
function randomCharacter(max){
  ...
  console.log(`${starWarsCharacters[random].name} is tall ${starWarsCharacters[random].height} cm. His weight is ${starWarsCharacters[random].mass} kg. His hair color is ${starWarsCharacters[random].hair_color} and his skin color is ${starWarsCharacters[random].skin_color} while his eye color is ${starWarsCharacters[random].eye_color}. He is born in ${starWarsCharacters[random].birth_year} and his gender is ${starWarsCharacters[random].gender}`);
}

randomCharacter(starWarsCharacters.length);